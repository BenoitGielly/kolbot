...
function LoadConfig() {
	...
	*/
	...
	Config.PickitFiles.push("skies/craft.nip");
	Config.PickitFiles.push("skies/magic_rare.nip");
	Config.PickitFiles.push("skies/misc.nip");
	Config.PickitFiles.push("skies/normal.nip");
	Config.PickitFiles.push("skies/set.nip");
	Config.PickitFiles.push("skies/unique.nip");
	Config.PickitFiles.push("skies/gheed.nip");
	...
	Config.Recipes.push([Recipe.Socket.Shield, "Vortex Shield", Roll.Eth]); // Socket ethereal Vortex
	...
	Config.AttackSkill[1] = 49; // Primary skill to bosses. //53
	...
	Config.StaticList = [156, 211, 243, "Mephisto"]; // List of monster NAMES or CLASSIDS to static. Example: Config.StaticList = ["Andariel", 243];
